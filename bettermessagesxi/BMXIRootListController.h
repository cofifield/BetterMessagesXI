...
#define TEXT_TINTCOLOR [UIColor colorWithRed:0.0 green:0.42 blue:1.0 alpha:1.0]
...
@interface BMXIRootListController : PSListController <UINavigationControllerDelegate, UIImagePickerControllerDelegate> {
}
@end
